...
public class Solution 
{
    ...
    public static int findRotationPoint(String[] words) 
    {
       ...
       return find(words,first,last,mid);
    }
public static int find(String [] words, int first, int last, int mid){
        if (first>=last)
            return mid;
    ...
    public void largeArrayTest() {
        final int actual = findRotationPoint(
            ...
            "asymptote", "babka", "banoffee", "englaster", "karpatka", "othellolagkage"});
